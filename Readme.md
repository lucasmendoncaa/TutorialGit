...
Link do video(créditos):
https://www.youtube.com/watch?v=UBAX-13g8OM&t=925s

## Criar um projeto novo

* Criar uma nova pasta no PC pra isso chamada `Git Tutorial`

* Abrir o seu programa de execução de códigos nessa pasta

* Criar um novo arquivo `README.md`

* Escrever dentro dele `Testando`

* Salva o arquivo

Agora é hora de usarmos o Git

* Abre o Git Bash que foi instalado na máquina (botão direito na pasta "Git bash here")
...
* Depois de você ter criado a sua conta no site GitHub, você irá em `Criar novo repositório`

Você vai preencher com as informações do projeto, então dar o nome do repositório, colocar uma breve descrição e criar

Logo depois vai aparecer uma página um pouco cinza e confusa e com vários comandos, mas o que você tem que fazer é bem simples, apenas copie o link os dois ultimos códigos e cole no Git bash(um de cada vez).
